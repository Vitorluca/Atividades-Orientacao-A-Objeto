...
#ifndef PRODUTO1_H // evita que o arquivo seja REDEFINIDO
#define PRODUTO1_H // define o arquivo produto

#include "produto.h" // inclui o arquivo produto.h 

class produto1 : public produto{ //nome da classe derivada e sua classe base
...
public: // //define o tipo de acesso dos atributos no caso é publico
    ...
    produto1(long int = 0, double = 0, long int = 0, string = "indefinido" ); //costrutor que inicializa os atributos
